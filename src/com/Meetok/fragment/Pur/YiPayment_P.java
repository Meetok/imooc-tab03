...
public class YiPayment_P extends Fragment {
	...
	public int lastItem;
	List<PurchaseEntity> mlist_cp = new ArrayList<PurchaseEntity>();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = LayoutInflater.from(getActivity()).inflate(R.layout.p_yipayment, null);
	...
	private void initView(View view) {
		...
		myListView = (ListView) view.findViewById(R.id.p_nopay_list);
		// 添加listview滚动监听
	...
	protected void loadData() {
		...
		handler.postDelayed(new Runnable() {
			...
			public void run() {
				...
				adapter_already_cp.notifyDataSetChanged();
			}
		}, 5000);
	}
				...
				new AbStringHttpResponseListener() {
					...
					public void onSuccess(int statusCode, String content) {
						...
						try {
							...
							adapter_already_cp = new Adapter_already_yi(
									getActivity(), mlist_cp);
							myListView.addFooterView(mFooterView);
							myListView.setAdapter(adapter_already_cp);
