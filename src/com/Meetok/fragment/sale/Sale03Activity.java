...
public class Sale03Activity  extends Fragment{
	...
	private Adapter_sale_all adapter_sale_all3;
	List<SaleEntity> list_sale3 = new ArrayList<SaleEntity>();
...
private String getmsg() {
	...
	String edit_B = EditText_2.getText().toString().trim();
	 msg_s = "\""+"HGStatus"+"\""+":"+"\""+"thdcl"+"\""+","+"\""+"searchparaA"+"\""+":"+"\""+edit_A+"\""+","+"\""+"searchProduct"+"\""+":"+"\""+edit_B+"\"";
return msg_s;
}
...
protected void loadData() {
	...
	handler.postDelayed(new Runnable() {
		...
		public void run() {
			...
			adapter_sale_all3.notifyDataSetChanged();
		}
	}, 5000);
}
				...
				public void onSuccess(int statusCode, String content) {
					...
					try {
						...
						JSONArray data1 = data.optJSONArray("data");
							...
							adapter_sale_all3 = new Adapter_sale_all(
									getActivity(), list_sale3);
							shou_listView.setAdapter(adapter_sale_all3);
