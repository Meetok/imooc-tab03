...
public class Sale05Activity  extends Fragment{
	...
	private Adapter_sale_all adapter_sale_all5;
	List<SaleEntity> list_sale5 = new ArrayList<SaleEntity>();
...
private String getmsg() {
	...
	String edit_B = EditText_2.getText().toString().trim();
	 msg_s = "\""+"HGStatus"+"\""+":"+"\""+""+"\""+","+"\""+"searchparaA"+"\""+":"+"\""+edit_A+"\""+","+"\""+"searchProduct"+"\""+":"+"\""+edit_B+"\"";
return msg_s;
}
...
protected void loadData() {
	...
	handler.postDelayed(new Runnable() {
		...
		public void run() {
			...
			adapter_sale_all5.notifyDataSetChanged();
		}
	}, 5000);
}
/**
				...
				public void onSuccess(int statusCode, String content) {
					...
					try {
						...
						JSONArray data1 = data.optJSONArray("data");
							...
							adapter_sale_all5 = new Adapter_sale_all(
									getActivity(), list_sale5);
							shou_listView.setAdapter(adapter_sale_all5);
