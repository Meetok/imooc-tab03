...
protected void onCreate(Bundle savedInstanceState) {
	...
	View view = LayoutInflater.from(AddSaleOrder.this).inflate(
	...
	button.setOnClickListener(new OnClickListener(){
	 ...
	 BASE_ACCESS = LogActivity.loadDataFromLocalXML(AddSaleOrder.this, "accesstoken");
...
private String getmsg() {
	...
	m5 = "\"name\":"+"\""+m5+"\""+",";
	String mother ="\"postfee\":"+"\""+5+"\""+","+"\"isxxdp\":"+"\""+"T"+"\""+","+"\"id\":"+"\""+""+"\""+",";
	...
	httpUtil.post(com.Meetok.config.Config.F_BASE_URL, params,
			new AbStringHttpResponseListener() {
				...
				public void onFailure(int statusCode, String content,
						Throwable error) {
					AbToastUtil.showToast(AddSaleOrder.this, error.getMessage());
				}
